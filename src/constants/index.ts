...
// ECU 모델 (PDF에서 추출한 실제 ECU 모델번호) - 마이그레이션용으로만 유지
...
// 기존 호환성을 위한 통합 연결방법 (Supabase 데이터와 동기화) - 마이그레이션용으로만 유지
export const CONNECTION_METHODS = [
  'OBD',
  'BENCH',
  'BOOT',
  'BDM',
  'FF',        // Supabase에서 추가된 데이터
  '직접입력'
] as const
...
// 고객 더미 데이터 - Supabase 마이그레이션 완료로 제거됨
// export const CUSTOMERS_DATA = [];

// 장비 더미 데이터 - Supabase 마이그레이션 완료로 제거됨
// export const EQUIPMENT_DATA = [];

// 작업 이력 더미 데이터 - Supabase 마이그레이션 완료로 제거됨
